...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center relative overflow-x-hidden font-sans">
      ...
      <div className="py-20 px-4 md:px-8 w-full flex flex-col items-center">

        {/* Decorative Grid Fades */}
        <div className="absolute top-8 left-0 w-full h-32 bg-gradient-to-b from-background to-transparent pointer-events-none z-10" />
